...
var Field = /*#__PURE__*/function () {
  ...
  _createClass(Field, [{
    ...
    key: "move0",
    value: function move0(toMove, i, j, idelta, jdelta) {
      ...
      if (!removeFromField) possiblyEmpty = this.fld[i + idelta][j + jdelta];
      if (possiblyEmpty != EMPTY) this.move0(possiblyEmpty, i + idelta, j + jdelta, idelta, jdelta);
      this.fld[i][j] = EMPTY;
      if (!removeFromField) this.fld[i + idelta][j + jdelta] = toMove;
...
//# sourceMappingURL=field.72c7b99f.js.map